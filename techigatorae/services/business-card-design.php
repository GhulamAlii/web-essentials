...
$pageTitle = "Result-Driven Business Card Design Company in Dubai, UAE";
$pageDescription = "Want to stand out with your business card design Dubai? Our expert business card designers in Dubai provide exceptional business card design services.";
...
<?php
$breadcrumbTitle = 'Business Card Design';
$bannerHeadingMain = 'Business Card Design Services in Dubai!';
$bannerHeadingsub = 'Build strong connections with every business card exchange!';
$bannerdesc = 'Your business card is not just a medium for sharing your contact details - it\'s more than that. At <a class="theme_color" href="' . $actual_link . '">techigator.ae</a>, we understand that your business card design holds significant importance in communicating your brand voice and persona. Our expert business card designers craft simple, elegant yet profound business cards to help you secure a distinct place in this saturated market.';
$btnTextOne = 'Share Your Business Details!';
$btnTextTwo = 'View Samples';
...
<?php
$title = '<span class="sectionTitleSpan">Business Card Design</span> <br> To Make a Lasting Impact!';
$Desc = 'At our <a class="theme_color" href="' . $actual_link . 'services/business-card-design">business card design Dubai</a> agency, we focus on quality more than anything else, and we never compromise on it at any stage. We create intuitive business card design that communicate your contact details while maintaining a clear brand voice throughout the design. Our skilled designers use high-quality stock and mindful layouts to pique the audience\'s interest and drive interactions. <br><br> As a leading logo design company in Dubai, we know how to perfectly incorporate branded elements onto your business cards. Moreover, you get the liberty to choose a custom size and shape for your business card, it could be the standard size that\'s 3.5” x 2”, or any other that fits your bill. <br><br> You get so many trendy business card design options to select from (Not Limited To):';

$btnTextOne = 'Discuss Your Requirements!';

$ImageOne = 'services/business-card-about.webp';
...
$listOptions = [
   [
      "list" => "Foldable Business Cards",
   ],
   [
      "list" => "Die-Cut Business Cards",
   ],
   [
      "list" => "Transparent Business Cards",
   ],
   [
      "list" => "Embossed Business Cards",
   ],
   [
      "list" => "Spot UV Business Cards",
   ],
];
...
<?php
$title = '<span>Team Up With Expert Business </span> <br> Card Designers and Build Credibility!';
$desc = "Avail the best business card design services in Dubai, and let's redefine your brand's presence with some sophisticated yet intriguing business card designs. We craft each and every business card design with special consideration to make your next card exchange a potential business opportunity. <br> <br> Don't settle for empty promises—let our expert designers create standout business cards that make a real impact!";

$cta_img = 'services/business-card-Appcta';
$cta_imgAlt = "Business Card Designers";
$cta_imgTitle = "Business Card Designers";

$ctaBtnTextOne = 'Get Your Business Card Design!';
...
<?php
$title = 'Purposeful Business Card Design <br> <span>To Enhance Brand Persona!</span>';
$des = "";
$smElm = 'smElm.webp';
$smElmalt = "image";
$smElmtitle = "image";
...
$appServices = [
   [
      ...
      'desc' => "At our business card design company, we understand that no two businesses are the same, so why should your business card be? We create fully customized business card design that reflects your brand's unique identity. Each and every detail is added to enhance your brand persona while keeping it simple and professional.",
   ],
   [
      'title' => "Digital Integration",
      'desc' => "At our tech-driven business card design company, we go beyond traditional cards that fade over time. We offer digital cards like NFC business cards that let you easily update contact details and share information with just a tap. No need for reprints—our cards keep your brand modern, adaptable, and ready for the future!",
   ],
   [
      'title' => "Design Formats",
      'desc' => "We offer a variety of design formats to suit your brand's style. You can pick from any format from sleek, minimalist layouts to bold, creative designs, we ensure every format reflects your brand's identity. Whether you prefer standard, foldable, or even die-cut designs, we design cards that stand out and create a special place in your audience's mind!",
   ],
   [
      'title' => "Fast Turnaround",
      'desc' => "We provide creative business card design services, making sure that we deliver high-quality business cards with a fast turnaround. We don't believe in long waits and empty promises—just quick, professional service that gets your cards ready when you need them, without compromising on quality.",
   ],
   [
      'title' => "Cost-Effective Designs",
      'desc' => "Techigator AE provides modern business card designs that are cost-effective without sacrificing quality. We believe that great designs shouldn't cost you an arm and a leg, so we create beautiful, professional cards that fit your budget and make your brand stand out.",
   ],
];
...
$casePortfolio = [
   [
      "img-src" => "business-card-case-studies1",
      "alt" => "Business Card Design in UAE",
      "title" => "Business Card Design in UAE",
   ],
   [
      "img-src" => "business-card-case-studies2",
...
$CTA_TITLE = '<span>Make Every Introduction Memorable With</span> <br> Our Business Card Design Dubai Company!';
$CTA_desc = "Share your business details in a compelling way that your prospect can't ignore, and convert these interactions into growth opportunities.";
...
$FAQ_title = "Questions We Frequently Answer At Our Business<br><span>  Card Design Company Dubai</span>";
...
$faqs = [
   [
      "question" => "What makes Techigator AE the best choice for business card design?",
      "answer" => 'We specialize in creating customized <a class="theme_color" href="' . $actual_link . 'services/business-card-design"> business card designs</a> that truly represent your brand. Our expert designers combine creativity and professionalism to ensure your cards leave a lasting impression.',
   ],
   [
      "question" => "How long does it take to design a custom business card?",
      "answer" => "Designing a custom business card usually takes about 1 to 2 weeks. The exact timeline may vary based on your specific requirements and the number of revisions needed.",
   ],
   [
      "question" => "What is the average cost of designing a professional business card?",
      "answer" => "The average cost for designing a professional business card ranges from AED 300 to AED 1,500. This varies depending on the design complexity and any special features you want.",
   ],
   [
      "question" => "Can I request revisions on my business card design?",
      "answer" => "Absolutely! We encourage feedback and offer revisions to ensure your business card design meets your expectations perfectly. Your satisfaction is our priority.",
   ],
