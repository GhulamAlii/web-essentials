...
$ImageOne = 'services/demand1.png';
$ImageOneAlt = "On-Demand Mobile App Development company";
$ImageOneTitle = "On-Demand Mobile App Development company";
...
$cta_img = 'services/demand2';
$cta_imgAlt = "On Demand App Developers in Dubai";
$cta_imgTitle = "On Demand App Developers in Dubai";
...
$casePortfolio = [
   [
      "img-src" => "demand4",
      "alt" => "On-Demand Mobile Apps",
      "title" => "On-Demand Mobile Apps",
   ],
   [
      "img-src" => "demand3",
      "alt" => "On Demand mobile Apps Developer UAE",
      "title" => "On Demand mobile Apps Developer UAE",
   ],
];
