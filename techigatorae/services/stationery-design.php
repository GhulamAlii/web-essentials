...
$pageTitle = "Creative Stationery Design Company in Dubai, UAE | Techigator AE";
$pageDescription = "As a top Stationery Design Company Dubai, we uplift your brand through compelling stationery design expertise, our goal is to make your brand known and recognized by business stationery design expertise.";
...
<?php
$breadcrumbTitle = 'Stationary Design';
$bannerHeadingMain = 'Impactful Stationery Design Company in Dubai!';
$bannerHeadingsub = 'Tired of generic stationery designs that look and feel the same?';
$bannerdesc = "Say goodbye to these boring design and branding practices. You can't deny the fact that your branding also lies in the design of your stationery that most of your prospects come across. These designs are the delegated speakers that speak for your brand in front of those likely to convert eyeballs. Our top-notch business stationery design expertise helps you make your presence matter in this competitive market.";
...
<?php
$title = '<span class="sectionTitleSpan">Exceptional Stationery Design Service To</span> <br> Mark Your Presence!';
$Desc = 'Building a powerful brand isn’t a piece of cake. To make your voice heard, you need to remind your audience about your brand in a captivating way. This could be anything from a billboard on the <a href="' . $actual_link . 'services/logo-design-dubai">road to a logo</a> on their coffee mug. However, the best way to create awareness in an office environment is through office stationery designs. Your audience sees your brand on pens, notebooks, envelopes, and even on a simple pencil. That’s how corporate stationery design Dubai works wonders for your brand elevation. <br><br> At techigator.ae, we have a team of skilled designers and marketing strategists who understand the importance of every design element. We focus on creating stationery that reflects your brand\'s identity and values. <br><br> We offer a wide range of essential stationery designs to elevate your brand presence:';

$btnTextOne = 'Discuss Your Stationery Design Needs!';

$ImageOne = 'services/stationery-about-img.webp';
$ImageOneAlt = "Stationery Design Service";
$ImageOneTitle = "Stationery Design Service";
...
$listOptions = [
   [
      "list" => "Office Stationery Designs",
   ],
   [
      "list" => "Wedding Stationery Designs",
   ],
   [
      "list" => "Promotional Stationery Designs",
   ],
   [
      "list" => "Personal Stationery Designs",
   ],
   [
      "list" => "Event Stationery Designs",
   ],
];
...
<?php
$title = '<span>Hire Us To Make A </span> <br> Lasting Brand Impact!';
$desc = "We design stationery that everyone loves to get hold of, making your brand's message conveyed in a direct yet rapid way to a wider audience. We strategically plan our stationery designs to vibe well with a bigger audience irrespective of their age and preferences - everyone loves our designs alike. <br><br> Partner with us to convey your brand message to its best.";

$cta_img = 'services/stationery-appCta';
$cta_imgAlt = "Stationery designers UAE";
$cta_imgTitle = "Stationery designers UAE";
...
<?php
$title = 'Captivating Stationery Design <br> <span>For a Noticeable Impact!</span>';
$desc = "If you want your stationery to stand out from others, you first need to stop wasting your time and money on those standard stationery designs that appeal to none. Our creative team of designers makes customized stationery designs that truly represent your vision and spread awareness about your garden.";
$smElm = 'smElm.webp';
$smElmalt = "image";
$smElmtitle = "image";
...
$appServices = [
   [
      ...
      'desc' => "At Techigator AE, we believe every business is unique, and so should its stationery. Our stationery designs are tailored just for you so that they can resonate with your audience. We craft eye-catching designs that leave a lasting impression, making your brand memorable. With our creative touch, your stationery will not just serve a purpose but also tell your story!",
   ],
   [
      'title' => "High-Level Creativity",
      'desc' => "As a leading <a class='theme_color' href='" . $actual_link . "services/stationery-design'>stationery design company in Dubai</a>, we are proud of our creative abilities. Our design experts bring unique and stunning elements to your stationery, ensuring it stands out from the crowd. We don't settle for generic or bland designs that fail to engage your audience.",
   ],
   [
      'title' => "Less Is More",
      'desc' => "We believe in <b>Less Is More</b>. Our stationery designs embrace simplicity, keeping things clean and uncluttered. We focus on a minimalist approach that enhances the appeal of your brand. By avoiding overload, we create striking designs that leave a lasting impression without overwhelming your audience.",
   ],
   [
      'title' => "Quick Design Time",
      'desc' => "Our seasoned designers make it possible to deliver high-quality designs within a relatively short time. They work efficiently to deliver your project with a quick turnaround time, while still leaving room for any updates you want to make. This way, you get a polished and <a class='theme_color' href='" . $actual_link . "services/brochure-design-dubai'>perfect brochure</a> ready to impress your target market!",
   ],
   [
      'title' => "Budget-Friendly Designs",
      'desc' => "Our core belief is that a design shouldn't break the bank. We focus on delivering under-budget designs without compromising quality. By avoiding unnecessary expenses and using effective design tools, we help you achieve your goals efficiently. Our stationery designs are crafted to fit your budget and serve their purpose perfectly, spreading your brand awareness to a wider audience.",
   ],
];
...
$casePortfolio = [
   [
      "img-src" => "stationery_case-studies1",
      "alt" => "stationery designs speaks",
      "title" => "stationery designs speaks",
   ],
   [
      "img-src" => "stationery_case-studies2",
      "alt" => "stationery design experts",
      "title" => "stationery design experts",
   ],
];
...
$CTA_TITLE = '<span>We Make Tangible Brand</span><br> Interactions Convert!';
$CTA_desc = "Don't hesitate to show your audience about your brand through our stellar stationery designs. Let's discover your brand's true potential and make your presence mark.";
$BtnText = 'Get Your Stationery Design Ready!';
...
$FAQ_title = "Questions We Frequently Answer At Our Stationery<br><span>  Design Company Dubai </span>";
...
$faqs = [
   [
      "question" => "What makes Techigator AE the best choice for stationery design?",
      "answer" => "We stand out for our tailored stationery design services. We focus on creating unique and impactful designs that align perfectly with your brand identity. Our team combines creative flair with strategic thinking, ensuring your stationery not only looks great but also communicates effectively.",
   ],
   [
      "question" => "How long does your company take to design custom stationery?",
      "answer" => "Typically, it takes between 1 to 2 weeks to design custom stationery. This timeframe can vary depending on your specific needs and any additional elements you want included.",
   ],
   [
      "question" => "What is the average cost of designing professional stationery?",
      "answer" => "The average cost for designing professional stationery ranges from <b class='theme_color'>AED 800</b> to <b class='theme_color'>AED 4,000</b>. This varies based on the complexity of the design and the specific elements you require.",
   ],
